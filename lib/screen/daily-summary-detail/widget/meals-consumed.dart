...
import 'package:nutriheart/model/model.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:nutriheart/widget/meal-consumed-tile.dart';

class MealsConsumed extends StatefulWidget {
  const MealsConsumed({Key? key}) : super(key: key);
    ...
    mealsConsumed.add(MealConsumed(
        ...
        consumedFoods: [
          FoodConsumed(
            ...
            icon: SvgPicture.asset('assets/icons/tea.svg',
    ...
    mealsConsumed.add(MealConsumed(
        ...
        consumedFoods: [
          FoodConsumed(
            ...
            boxColor: AppColors.colorTint200,
            icon: SvgPicture.asset('assets/icons/chicken.svg',
                width: 25.w, height: 25.w),
          ),
          FoodConsumed(
            ...
            boxColor: AppColors.colorErrorLight,
            icon: SvgPicture.asset('assets/icons/salad.svg',
                width: 25.w, height: 25.w),
          )
        ]));
    ...
    mealsConsumed.add(MealConsumed(
        ...
        consumedFoods: [
          FoodConsumed(
            ...
            boxColor: AppColors.colorTint200,
            icon: SvgPicture.asset('assets/icons/pasta.svg',
                width: 25.w, height: 25.w),
          ),
        ]));
  }
